...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception{
		...
		.antMatchers("/pessoa/formulario").permitAll()      //hasRole("USER")
		.antMatchers("/pessoa/cadastrar").permitAll()
		.antMatchers("/pessoa/listar").hasRole("GERENTE")
		.antMatchers("/gerentes").hasRole("GERENTE")
		.antMatchers("/gerentes/deletar/{id}").hasRole("GERENTE")
		.antMatchers("/gerentes/listarPratos").hasRole("GERENTE")
